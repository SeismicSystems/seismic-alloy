...
use alloy_primitives::{
    keccak256, Bytes, ChainId, FixedBytes, PrimitiveSignature as Signature,
    TxKind, B256, U256,
};
...
impl Signed<TxSeismic> {
    ...
    pub fn recover_caller(&self) -> Result<alloy_primitives::Address, alloy_primitives::SignatureError> {
        let tx = self.tx();
